...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("User Id=postgres;Password=52e481f9-44fb-4746-ab4b-b2853fd5f330;Server=db.vhttstugyubipiukoekn.supabase.co;Port=5432;Database=postgres");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Game>(entity =>
        {
            ...
            entity.Property(e => e.AveragePlaytimeForever).HasColumnName("Average playtime forever");
            entity.Property(e => e.AveragePlaytimeTwoWeeks).HasColumnName("Average playtime two weeks");
            entity.Property(e => e.DlcCount).HasColumnName("DLC count");
            ...
            entity.Property(e => e.MedianPlaytimeForever).HasColumnName("Median playtime forever");
            entity.Property(e => e.MedianPlaytimeTwoWeeks).HasColumnName("Median playtime two weeks");
            entity.Property(e => e.MetacriticScore).HasColumnName("Metacritic score");
            entity.Property(e => e.MetacriticUrl).HasColumnName("Metacritic url");
            entity.Property(e => e.PeakCcu).HasColumnName("Peak CCU");
            entity.Property(e => e.ReleaseDate).HasColumnName("Release date");
            entity.Property(e => e.RequiredAge).HasColumnName("Required age");
            entity.Property(e => e.ScoreRank).HasColumnName("Score rank");
            ...
            entity.Property(e => e.UserScore).HasColumnName("User score");
        });
        ...
        modelBuilder.Entity<TbGameHeader>(entity =>
        {
            entity.HasKey(e => e.AppId).HasName("tb_game_header_pkey");

            entity.ToTable("tb_game_header");

            entity.Property(e => e.AppId)
                .ValueGeneratedNever()
                .HasColumnName("AppID");
            entity.Property(e => e.Developers).HasDefaultValueSql("''::text");
